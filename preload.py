...
cs_base_color = "#0077B6"  # IIT Gandhinagar teal/blue theme
cs_header = "CCL CT"  # the upper-left corner
cs_icon_url = "COURSE/favicon_local.gif"  # the favicon, if any
# the 'header' text for the page
cs_long_name = cs_content_header = "Computational Thinking"
cs_title = "Computational Thinking"  # the browser's title bar
...
# AUTHENTICATION
# Use login-based authentication (username/password)
cs_auth_type = "login"
cs_allow_registration = True  # Allow new users to register
cs_require_confirm_email = False  # No email confirmation needed for local testing
